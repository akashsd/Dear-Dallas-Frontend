...
import { Star, Building2, Waves } from 'lucide-react';
import aiAvatar from '../../assets/images/AI Avatar 3.png';
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex justify-center mb-12">
            <div className="relative">
              <div className="w-80 h-80 bg-gradient-to-br from-blue-600 to-teal-500 dark:from-blue-400 dark:to-teal-400 hc:from-yellow-400 hc:to-yellow-500 rounded-3xl flex items-center justify-center shadow-xl transform hover:scale-105 transition-transform duration-300 p-4">
                <img src={aiAvatar} alt="AI Assistant" className="w-full h-full object-contain" />
              </div>
            </div>
          </div>
